(function(){
  const tabTemplate = `
    <div class="chrome-tab">
      ...
      <div class="chrome-tab-site"></div>
      <div class="chrome-tab-id"></div>
  ...
  class ChromeTabs {
    ...
    updateTab(tabEl, tabProperties) {
      ...
      tabEl.querySelector('.chrome-tab-id').textContent = tabProperties.site;
      tabEl.querySelector('.chrome-tab-site').textContent = tabProperties.site;
    }
